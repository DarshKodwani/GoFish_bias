...
print "---------GPD----------\n ", print_sigmas("Fisher_lens_cluster/Fisher_lenscluster_full_GPD_fsky1")
print "---------GPI----------\n ", print_sigmas("Fisher_lens_cluster/Fisher_lenscluster_full_GPI_fsky1")
print "---------SPD----------\n ", print_sigmas("Fisher_lens_cluster/Fisher_lenscluster_full_SPD_fsky1")
print "---------SPI----------\n", print_sigmas("Fisher_lens_cluster/Fisher_lenscluster_full_SPI_fsky1")
