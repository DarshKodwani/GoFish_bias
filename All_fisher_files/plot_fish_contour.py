...
fg = plt.figure()
fsh.plot_fisher_two(pars,'w0','wa',[fish_GPI['fisher_cls'], fish_GPD['fisher_cls']], fg, [{'col':'#F7B825','ls':'solid','lw':2,'alpha':1.0},{'col':'#0066CC','ls':'solid','lw':2,'alpha':1.0}],2.,'Fish_two')
plt.show()
